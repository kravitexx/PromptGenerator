          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 sm:gap-8 text-center sm:text-left">
            ...
            <div className="space-y-2">
              ...
              <ul className="space-y-1 text-sm">
                ...
                <li><Link href="/cookies" className="text-gray-600 hover:text-blue-600 transition-colors">Cookies</Link></li>
              </ul>
            </div>
          </div>
...
}terms" className="text-gray-600 hover:text-blue-600 transition-colors">Terms</Link></li>
                <li><Link href="/cookies" className="text-gray-600 hover:text-blue-600 transition-colors">Cookies</Link></li>
              </ul>
            </div>
          </div>
